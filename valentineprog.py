...
t.goto(0,150)
t.color("red")
t.write("Hey! this is for you....Happy Birthday my sweetheart", None, align="center", font=("Arial", 14, "bold"))
t.goto(1,-125)
...
t.goto(0,-100)
t.color("red")
t.write("Roses are red.", None, "center", " bold")
t.goto(1,-125)
t.write("Violets are blue.", None, "center", " bold")
t.goto(2,-150)
t.write("I love coding...", None, "center", " bold")
t.goto(3,-175)
t.write("Do you love too?", None, "center", " bold")
t.color("white")
t.goto(0,-300)
